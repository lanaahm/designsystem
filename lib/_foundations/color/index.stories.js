...
export const Example = () => (React.createElement(SystemBlock, null,
    React.createElement(Stack, { spacing: "xl" },
        React.createElement(ComponentBlock, { title: "Primary colors", scaleTitle: "heading5", withBackground: true },
            React.createElement(Box, { display: "grid", gridGap: "20px", gridTemplateRows: "340px", gridTemplateColumns: "600px" },
                React.createElement(Box, { display: "flex" },
                    React.createElement(Box, { flex: "1", width: "100%", position: "relative", display: "flex", alignItems: "stretch", boxShadow: "0px 5px 20px rgba(128, 128, 128, 0.1)", color: colors.white },
                        React.createElement(Box, { display: "flex", flex: "1", flexDirection: "column", width: "100%", p: "20px", background: colors.biru },
                            React.createElement(Heading, { color: colors.white, scale: "heading5" }, "Biru"),
                            React.createElement(Paragraph, { scale: "subtitle1" },
                                "HEX : ",
                                colors.biru),
                            React.createElement(Paragraph, { scale: "subtitle1" },
                                "RGB : ",
                                colors.biru)),
                        React.createElement(Box, { flex: "0 0 40%", display: "flex", flexDirection: "column", overflow: "hidden" },
                            React.createElement(Box, { flex: "1 1 auto", background: colors.hitam, display: "flex", position: "relative", overflow: "hidden", flexDirection: "column", p: "20px" },
                                ...
                                React.createElement(Paragraph, { scale: "subtitle1" },
                                    "RGB : ",
                                    colors.hitam)),
                            React.createElement(Box, { flex: "1 1 auto", background: colors.putih, display: "flex", position: "relative", overflow: "hidden", flexDirection: "column", p: "20px", color: colors.black },
                                ...
                                React.createElement(Paragraph, { scale: "subtitle1" },
                                    "RGB : ",
                                    colors.putih))))))),
        React.createElement(ComponentBlock, { title: "Secondary colors", scaleTitle: "heading5", withBackground: true },
            React.createElement(Box, { mb: 24 },
                React.createElement(Box, { backgroundColor: colors.orange, display: "inline-block", verticalAlign: "top", width: "120px", height: "120px" }),
                React.createElement(Box, { ml: 12, display: "inline-block", verticalAlign: "top" },
                    ...
                    React.createElement(Paragraph, { scale: "subtitle1" },
                        ...
                        colors.orange))),
            React.createElement(Box, { mb: 24 },
                React.createElement(Box, { backgroundColor: colors.merah, display: "inline-block", verticalAlign: "top", width: "120px", height: "120px" }),
                React.createElement(Box, { ml: 12, display: "inline-block", verticalAlign: "top" },
                    ...
                    React.createElement(Paragraph, { scale: "subtitle1" },
                        ...
                        colors.merah))),
            React.createElement(Box, { mb: 24 },
                React.createElement(Box, { backgroundColor: colors.hijau, display: "inline-block", verticalAlign: "top", width: "120px", height: "120px" }),
                React.createElement(Box, { ml: 12, display: "inline-block", verticalAlign: "top" },
                    ...
                    React.createElement(Paragraph, { scale: "subtitle1" },
                        "RGB : ",
                        colors.hijau)))),
        React.createElement(ComponentBlock, { title: "Saturation dan Shade", scaleTitle: "heading5", withBackground: true },
            React.createElement(Box, { display: "grid", width: "75%", gridGap: "5%", gridTemplateColumns: "repeat(3,1fr)", mb: "calc(3px + 5%)", mx: "auto" },
                React.createElement(Box, { display: "flex", flexDirection: "column", width: "100%", height: "50%" },
