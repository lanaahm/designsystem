...
export const Skelaton = () =>
  React.createElement(
    SystemBlock,
    { title: 'BCC Design System - Typography', subtitle: '' },
    React.createElement(
      Stack,
      { spacing: 'xl' },
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            Paragraph,
            { className: 'skeleton w15' },
            'Open sans merupakan humanist sans-serif typeface didesign oleh Steve Matteson setela diberi tugas oleh google dan dirilis pada tahun 2011. Font ini merupakan font sebelumnya yaitu Droid sans, yang didesign untuk digunakan pada android'
          ),
          React.createElement(
            Paragraph,
            { className: 'skeleton' },
            'Open sans umum digunakan pada halaman web, browser (digunakan mozilla sampai tahun 2019), dekstop app (Telegram). Penggunaan open sans dioptimalkan untuk bacaan dengan blbalbala'
          ),
          React.createElement(
            Paragraph,
            { className: 'skeleton' },
            'Open sans sebagai sans-serif dengan sifat tegas dan moern dipilih sesuai dari init dari hasil research yang didapatkan yaitu kekeluargaan dan visioner segabagai ciri khas dan pandangan orang lain terpadahp BCC FILKOM.'
          ),
          React.createElement(
            Paragraph,
            { className: 'skeleton' },
