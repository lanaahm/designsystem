...
declare const _default: {
  title: string;
  component: (
    | import('styled-components').StyledComponent<'h2', any, import('.').HeadingProps, never>
    | import('styled-components').StyledComponent<'span', any, import('.').TextProps, never>
    | import('styled-components').StyledComponent<'p', any, import('.').ParagraphProps, never>
  )[];
